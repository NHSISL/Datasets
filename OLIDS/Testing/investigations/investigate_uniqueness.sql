...
UNION ALL
SELECT 'PATIENT', 'lds_source_record_id', lds_source_record_id, COUNT(*)
FROM OLIDS_MASKED.PATIENT GROUP BY lds_source_record_id HAVING COUNT(*) > 1
UNION ALL
...
UNION ALL
SELECT 'PERSON', 'lds_source_record_id', lds_source_record_id, COUNT(*)
FROM OLIDS_MASKED.PERSON GROUP BY lds_source_record_id HAVING COUNT(*) > 1
UNION ALL
...
UNION ALL
SELECT 'PATIENT_ADDRESS', 'lds_source_record_id', lds_source_record_id, COUNT(*)
FROM OLIDS_MASKED.PATIENT_ADDRESS GROUP BY lds_source_record_id HAVING COUNT(*) > 1
UNION ALL
...
UNION ALL
SELECT 'PATIENT_CONTACT', 'lds_source_record_id', lds_source_record_id, COUNT(*)
FROM OLIDS_MASKED.PATIENT_CONTACT GROUP BY lds_source_record_id HAVING COUNT(*) > 1
UNION ALL
...
UNION ALL
SELECT 'PATIENT_UPRN', 'lds_source_record_id', lds_source_record_id, COUNT(*)
FROM OLIDS_MASKED.PATIENT_UPRN GROUP BY lds_source_record_id HAVING COUNT(*) > 1
UNION ALL
...
-- PATIENT_PERSON
SELECT 'PATIENT_PERSON', 'lds_source_record_id', lds_source_record_id, COUNT(*)
FROM OLIDS_COMMON.PATIENT_PERSON GROUP BY lds_source_record_id HAVING COUNT(*) > 1
UNION ALL
...
UNION ALL
SELECT 'EPISODE_OF_CARE', 'lds_source_record_id', lds_source_record_id, COUNT(*)
FROM OLIDS_COMMON.EPISODE_OF_CARE GROUP BY lds_source_record_id HAVING COUNT(*) > 1
UNION ALL
...
UNION ALL
SELECT 'ENCOUNTER', 'lds_source_record_id', lds_source_record_id, COUNT(*)
FROM OLIDS_COMMON.ENCOUNTER GROUP BY lds_source_record_id HAVING COUNT(*) > 1
UNION ALL
...
UNION ALL
SELECT 'OBSERVATION', 'lds_source_record_id', lds_source_record_id, COUNT(*)
FROM OLIDS_COMMON.OBSERVATION GROUP BY lds_source_record_id HAVING COUNT(*) > 1
UNION ALL
...
UNION ALL
SELECT 'MEDICATION_STATEMENT', 'lds_source_record_id', lds_source_record_id, COUNT(*)
FROM OLIDS_COMMON.MEDICATION_STATEMENT GROUP BY lds_source_record_id HAVING COUNT(*) > 1
UNION ALL
...
UNION ALL
SELECT 'MEDICATION_ORDER', 'lds_source_record_id', lds_source_record_id, COUNT(*)
FROM OLIDS_COMMON.MEDICATION_ORDER GROUP BY lds_source_record_id HAVING COUNT(*) > 1
UNION ALL
...
UNION ALL
SELECT 'DIAGNOSTIC_ORDER', 'lds_source_record_id', lds_source_record_id, COUNT(*)
FROM OLIDS_COMMON.DIAGNOSTIC_ORDER GROUP BY lds_source_record_id HAVING COUNT(*) > 1
UNION ALL
...
UNION ALL
SELECT 'ALLERGY_INTOLERANCE', 'lds_source_record_id', lds_source_record_id, COUNT(*)
FROM OLIDS_COMMON.ALLERGY_INTOLERANCE GROUP BY lds_source_record_id HAVING COUNT(*) > 1
UNION ALL
...
UNION ALL
SELECT 'PROCEDURE_REQUEST', 'lds_source_record_id', lds_source_record_id, COUNT(*)
FROM OLIDS_COMMON.PROCEDURE_REQUEST GROUP BY lds_source_record_id HAVING COUNT(*) > 1
UNION ALL
...
UNION ALL
SELECT 'REFERRAL_REQUEST', 'lds_source_record_id', lds_source_record_id, COUNT(*)
FROM OLIDS_COMMON.REFERRAL_REQUEST GROUP BY lds_source_record_id HAVING COUNT(*) > 1
UNION ALL
...
UNION ALL
SELECT 'APPOINTMENT', 'lds_source_record_id', lds_source_record_id, COUNT(*)
FROM OLIDS_COMMON.APPOINTMENT GROUP BY lds_source_record_id HAVING COUNT(*) > 1
UNION ALL
...
UNION ALL
SELECT 'PATIENT_REGISTERED_PRACTITIONER_IN_ROLE', 'lds_source_record_id', lds_source_record_id, COUNT(*)
FROM OLIDS_COMMON.PATIENT_REGISTERED_PRACTITIONER_IN_ROLE GROUP BY lds_source_record_id HAVING COUNT(*) > 1
UNION ALL
...
UNION ALL
SELECT 'LOCATION', 'lds_source_record_id', lds_source_record_id, COUNT(*)
FROM OLIDS_COMMON.LOCATION GROUP BY lds_source_record_id HAVING COUNT(*) > 1
UNION ALL
...
UNION ALL
SELECT 'LOCATION_CONTACT', 'lds_source_record_id', lds_source_record_id, COUNT(*)
FROM OLIDS_COMMON.LOCATION_CONTACT GROUP BY lds_source_record_id HAVING COUNT(*) > 1
UNION ALL
...
UNION ALL
SELECT 'ORGANISATION', 'lds_source_record_id', lds_source_record_id, COUNT(*)
FROM OLIDS_COMMON.ORGANISATION GROUP BY lds_source_record_id HAVING COUNT(*) > 1
UNION ALL
...
UNION ALL
SELECT 'PRACTITIONER', 'lds_source_record_id', lds_source_record_id, COUNT(*)
FROM OLIDS_COMMON.PRACTITIONER GROUP BY lds_source_record_id HAVING COUNT(*) > 1
UNION ALL
...
UNION ALL
SELECT 'PRACTITIONER_IN_ROLE', 'lds_source_record_id', lds_source_record_id, COUNT(*)
FROM OLIDS_COMMON.PRACTITIONER_IN_ROLE GROUP BY lds_source_record_id HAVING COUNT(*) > 1
UNION ALL
...
UNION ALL
SELECT 'SCHEDULE', 'lds_source_record_id', lds_source_record_id, COUNT(*)
FROM OLIDS_COMMON.SCHEDULE GROUP BY lds_source_record_id HAVING COUNT(*) > 1
UNION ALL
...
UNION ALL
SELECT 'SCHEDULE_PRACTITIONER', 'lds_source_record_id', lds_source_record_id, COUNT(*)
FROM OLIDS_COMMON.SCHEDULE_PRACTITIONER GROUP BY lds_source_record_id HAVING COUNT(*) > 1
UNION ALL
...
SELECT 'CONCEPT', 'concept_id', concept_id, COUNT(*)
FROM OLIDS_TERMINOLOGY.CONCEPT GROUP BY concept_id HAVING COUNT(*) > 1
UNION ALL

-- CONCEPT_MAP (no lds_record_id)
SELECT 'CONCEPT_MAP', 'mapped_item_id', mapped_item_id, COUNT(*)
FROM OLIDS_TERMINOLOGY.CONCEPT_MAP GROUP BY mapped_item_id HAVING COUNT(*) > 1
