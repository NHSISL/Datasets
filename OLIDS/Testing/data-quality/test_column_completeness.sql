...
WITH checks AS (
    ...
    UNION ALL SELECT 'OBSERVATION', 'result_value_units_concept_id', 5.0, COUNT(*), SUM(CASE WHEN result_value_units_concept_id IS NULL THEN 1 ELSE 0 END) FROM OLIDS_COMMON.OBSERVATION
    ...
    UNION ALL SELECT 'DIAGNOSTIC_ORDER', 'result_value_units_concept_id', 5.0, COUNT(*), SUM(CASE WHEN result_value_units_concept_id IS NULL THEN 1 ELSE 0 END) FROM OLIDS_COMMON.DIAGNOSTIC_ORDER
    ...
    UNION ALL SELECT 'REFERRAL_REQUEST', 'referral_request_type_concept_id', 5.0, COUNT(*), SUM(CASE WHEN referral_request_type_concept_id IS NULL THEN 1 ELSE 0 END) FROM OLIDS_COMMON.REFERRAL_REQUEST
