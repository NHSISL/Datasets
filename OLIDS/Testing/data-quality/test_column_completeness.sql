...
WITH checks AS (
    ...
    UNION ALL SELECT 'PATIENT_CONTACT', 'contact_type_concept_id', 5.0, COUNT(*), SUM(CASE WHEN contact_type_concept_id IS NULL THEN 1 ELSE 0 END) FROM OLIDS_MASKED.PATIENT_CONTACT
    ...
    UNION ALL SELECT 'EPISODE_OF_CARE', 'episode_type_raw_concept_id', 5.0, COUNT(*), SUM(CASE WHEN episode_type_raw_concept_id IS NULL THEN 1 ELSE 0 END) FROM OLIDS_COMMON.EPISODE_OF_CARE
    UNION ALL SELECT 'EPISODE_OF_CARE', 'episode_status_raw_concept_id', 5.0, COUNT(*), SUM(CASE WHEN episode_status_raw_concept_id IS NULL THEN 1 ELSE 0 END) FROM OLIDS_COMMON.EPISODE_OF_CARE
    ...
    UNION ALL SELECT 'OBSERVATION', 'result_value_unit_concept_id', 5.0, COUNT(*), SUM(CASE WHEN result_value_unit_concept_id IS NULL THEN 1 ELSE 0 END) FROM OLIDS_COMMON.OBSERVATION
    UNION ALL SELECT 'OBSERVATION', 'date_precision_concept_id', 5.0, COUNT(*), SUM(CASE WHEN date_precision_concept_id IS NULL THEN 1 ELSE 0 END) FROM OLIDS_COMMON.OBSERVATION
    UNION ALL SELECT 'OBSERVATION', 'episodicity_concept_id', 5.0, COUNT(*), SUM(CASE WHEN episodicity_concept_id IS NULL THEN 1 ELSE 0 END) FROM OLIDS_COMMON.OBSERVATION
    ...
    UNION ALL SELECT 'MEDICATION_STATEMENT', 'medication_statement_core_concept_id', 5.0, COUNT(*), SUM(CASE WHEN medication_statement_core_concept_id IS NULL THEN 1 ELSE 0 END) FROM OLIDS_COMMON.MEDICATION_STATEMENT
    UNION ALL SELECT 'MEDICATION_STATEMENT', 'authorisation_type_concept_id', 5.0, COUNT(*), SUM(CASE WHEN authorisation_type_concept_id IS NULL THEN 1 ELSE 0 END) FROM OLIDS_COMMON.MEDICATION_STATEMENT
    UNION ALL SELECT 'MEDICATION_STATEMENT', 'date_precision_concept_id', 5.0, COUNT(*), SUM(CASE WHEN date_precision_concept_id IS NULL THEN 1 ELSE 0 END) FROM OLIDS_COMMON.MEDICATION_STATEMENT
    ...
    UNION ALL SELECT 'MEDICATION_ORDER', 'medication_order_core_concept_id', 5.0, COUNT(*), SUM(CASE WHEN medication_order_core_concept_id IS NULL THEN 1 ELSE 0 END) FROM OLIDS_COMMON.MEDICATION_ORDER
    UNION ALL SELECT 'MEDICATION_ORDER', 'date_precision_concept_id', 5.0, COUNT(*), SUM(CASE WHEN date_precision_concept_id IS NULL THEN 1 ELSE 0 END) FROM OLIDS_COMMON.MEDICATION_ORDER
    ...
    UNION ALL SELECT 'DIAGNOSTIC_ORDER', 'date_precision_concept_id', 5.0, COUNT(*), SUM(CASE WHEN date_precision_concept_id IS NULL THEN 1 ELSE 0 END) FROM OLIDS_COMMON.DIAGNOSTIC_ORDER
    UNION ALL SELECT 'DIAGNOSTIC_ORDER', 'episodicity_concept_id', 5.0, COUNT(*), SUM(CASE WHEN episodicity_concept_id IS NULL THEN 1 ELSE 0 END) FROM OLIDS_COMMON.DIAGNOSTIC_ORDER
    ...
    UNION ALL SELECT 'ENCOUNTER', 'encounter_core_concept_id', 5.0, COUNT(*), SUM(CASE WHEN encounter_core_concept_id IS NULL THEN 1 ELSE 0 END) FROM OLIDS_COMMON.ENCOUNTER
    UNION ALL SELECT 'ENCOUNTER', 'date_precision_concept_id', 5.0, COUNT(*), SUM(CASE WHEN date_precision_concept_id IS NULL THEN 1 ELSE 0 END) FROM OLIDS_COMMON.ENCOUNTER
    ...
    UNION ALL SELECT 'ALLERGY_INTOLERANCE', 'date_precision_concept_id', 5.0, COUNT(*), SUM(CASE WHEN date_precision_concept_id IS NULL THEN 1 ELSE 0 END) FROM OLIDS_COMMON.ALLERGY_INTOLERANCE
    ...
    UNION ALL SELECT 'PROCEDURE_REQUEST', 'procedure_core_concept_id', 5.0, COUNT(*), SUM(CASE WHEN procedure_core_concept_id IS NULL THEN 1 ELSE 0 END) FROM OLIDS_COMMON.PROCEDURE_REQUEST
    UNION ALL SELECT 'PROCEDURE_REQUEST', 'date_precision_concept_id', 5.0, COUNT(*), SUM(CASE WHEN date_precision_concept_id IS NULL THEN 1 ELSE 0 END) FROM OLIDS_COMMON.PROCEDURE_REQUEST
    UNION ALL SELECT 'PROCEDURE_REQUEST', 'status_concept_id', 5.0, COUNT(*), SUM(CASE WHEN status_concept_id IS NULL THEN 1 ELSE 0 END) FROM OLIDS_COMMON.PROCEDURE_REQUEST
    ...
    UNION ALL SELECT 'REFERRAL_REQUEST', 'date_precision_concept_id', 5.0, COUNT(*), SUM(CASE WHEN date_precision_concept_id IS NULL THEN 1 ELSE 0 END) FROM OLIDS_COMMON.REFERRAL_REQUEST
    UNION ALL SELECT 'REFERRAL_REQUEST', 'referral_request_priority_concept_id', 5.0, COUNT(*), SUM(CASE WHEN referral_request_priority_concept_id IS NULL THEN 1 ELSE 0 END) FROM OLIDS_COMMON.REFERRAL_REQUEST
    UNION ALL SELECT 'REFERRAL_REQUEST', 'referal_request_type_concept_id', 5.0, COUNT(*), SUM(CASE WHEN referal_request_type_concept_id IS NULL THEN 1 ELSE 0 END) FROM OLIDS_COMMON.REFERRAL_REQUEST
    UNION ALL SELECT 'REFERRAL_REQUEST', 'referral_request_specialty_concept_id', 5.0, COUNT(*), SUM(CASE WHEN referral_request_specialty_concept_id IS NULL THEN 1 ELSE 0 END) FROM OLIDS_COMMON.REFERRAL_REQUEST
    ...
    UNION ALL SELECT 'LOCATION_CONTACT', 'contact_type_concept_id', 5.0, COUNT(*), SUM(CASE WHEN contact_type_concept_id IS NULL THEN 1 ELSE 0 END) FROM OLIDS_COMMON.LOCATION_CONTACT
    ...
    UNION ALL SELECT 'APPOINTMENT', 'appointment_status_concept_id', 5.0, COUNT(*), SUM(CASE WHEN appointment_status_concept_id IS NULL THEN 1 ELSE 0 END) FROM OLIDS_COMMON.APPOINTMENT
    UNION ALL SELECT 'APPOINTMENT', 'booking_method_concept_id', 5.0, COUNT(*), SUM(CASE WHEN booking_method_concept_id IS NULL THEN 1 ELSE 0 END) FROM OLIDS_COMMON.APPOINTMENT
    UNION ALL SELECT 'APPOINTMENT', 'contact_mode_concept_id', 5.0, COUNT(*), SUM(CASE WHEN contact_mode_concept_id IS NULL THEN 1 ELSE 0 END) FROM OLIDS_COMMON.APPOINTMENT
