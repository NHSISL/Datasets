/*
    ...
    Columns tested per table:
      ...
      - lds_source_record_id: LDS ingest record ID (lds_record_id on APPOINTMENT_PRACTITIONER)
      - lds_id: LDS entity ID
      - lds_business_key: LDS business key
    Note: PATIENT_PERSON has no id column. PATIENT_UPRN, CONCEPT and CONCEPT_MAP
    lack lds_business_key (CONCEPT/CONCEPT_MAP also lack lds_id).
...
WITH checks AS (
    ...
    UNION ALL SELECT 'PATIENT', 'lds_source_record_id', COUNT(*), COUNT(DISTINCT lds_source_record_id) FROM OLIDS_MASKED.PATIENT
    ...
    UNION ALL SELECT 'PERSON', 'lds_source_record_id', COUNT(*), COUNT(DISTINCT lds_source_record_id) FROM OLIDS_MASKED.PERSON
    ...
    UNION ALL SELECT 'PATIENT_ADDRESS', 'lds_source_record_id', COUNT(*), COUNT(DISTINCT lds_source_record_id) FROM OLIDS_MASKED.PATIENT_ADDRESS
    ...
    UNION ALL SELECT 'PATIENT_CONTACT', 'lds_source_record_id', COUNT(*), COUNT(DISTINCT lds_source_record_id) FROM OLIDS_MASKED.PATIENT_CONTACT
    ...
    -- PATIENT_UPRN (OLIDS_MASKED) — no lds_business_key in this table
    UNION ALL SELECT 'PATIENT_UPRN', 'id', COUNT(*), COUNT(DISTINCT id) FROM OLIDS_MASKED.PATIENT_UPRN
    UNION ALL SELECT 'PATIENT_UPRN', 'lds_source_record_id', COUNT(*), COUNT(DISTINCT lds_source_record_id) FROM OLIDS_MASKED.PATIENT_UPRN
    ...
    UNION ALL SELECT 'PATIENT_PERSON', 'lds_source_record_id', COUNT(*), COUNT(DISTINCT lds_source_record_id) FROM OLIDS_COMMON.PATIENT_PERSON
    ...
    UNION ALL SELECT 'ENCOUNTER', 'lds_source_record_id', COUNT(*), COUNT(DISTINCT lds_source_record_id) FROM OLIDS_COMMON.ENCOUNTER
    ...
    UNION ALL SELECT 'OBSERVATION', 'lds_source_record_id', COUNT(*), COUNT(DISTINCT lds_source_record_id) FROM OLIDS_COMMON.OBSERVATION
    ...
    UNION ALL SELECT 'MEDICATION_STATEMENT', 'lds_source_record_id', COUNT(*), COUNT(DISTINCT lds_source_record_id) FROM OLIDS_COMMON.MEDICATION_STATEMENT
    ...
    UNION ALL SELECT 'MEDICATION_ORDER', 'lds_source_record_id', COUNT(*), COUNT(DISTINCT lds_source_record_id) FROM OLIDS_COMMON.MEDICATION_ORDER
    ...
    UNION ALL SELECT 'DIAGNOSTIC_ORDER', 'lds_source_record_id', COUNT(*), COUNT(DISTINCT lds_source_record_id) FROM OLIDS_COMMON.DIAGNOSTIC_ORDER
    ...
    UNION ALL SELECT 'ALLERGY_INTOLERANCE', 'lds_source_record_id', COUNT(*), COUNT(DISTINCT lds_source_record_id) FROM OLIDS_COMMON.ALLERGY_INTOLERANCE
    ...
    UNION ALL SELECT 'PROCEDURE_REQUEST', 'lds_source_record_id', COUNT(*), COUNT(DISTINCT lds_source_record_id) FROM OLIDS_COMMON.PROCEDURE_REQUEST
    ...
    UNION ALL SELECT 'REFERRAL_REQUEST', 'lds_source_record_id', COUNT(*), COUNT(DISTINCT lds_source_record_id) FROM OLIDS_COMMON.REFERRAL_REQUEST
    ...
    UNION ALL SELECT 'APPOINTMENT', 'lds_source_record_id', COUNT(*), COUNT(DISTINCT lds_source_record_id) FROM OLIDS_COMMON.APPOINTMENT
    ...
    -- APPOINTMENT_PRACTITIONER (OLIDS_COMMON) — uses lds_record_id (not lds_source_record_id)
    ...
    UNION ALL SELECT 'PATIENT_REGISTERED_PRACTITIONER_IN_ROLE', 'lds_source_record_id', COUNT(*), COUNT(DISTINCT lds_source_record_id) FROM OLIDS_COMMON.PATIENT_REGISTERED_PRACTITIONER_IN_ROLE
    ...
    UNION ALL SELECT 'LOCATION', 'lds_source_record_id', COUNT(*), COUNT(DISTINCT lds_source_record_id) FROM OLIDS_COMMON.LOCATION
    ...
    UNION ALL SELECT 'LOCATION_CONTACT', 'lds_source_record_id', COUNT(*), COUNT(DISTINCT lds_source_record_id) FROM OLIDS_COMMON.LOCATION_CONTACT
    ...
    UNION ALL SELECT 'ORGANISATION', 'lds_source_record_id', COUNT(*), COUNT(DISTINCT lds_source_record_id) FROM OLIDS_COMMON.ORGANISATION
    ...
    UNION ALL SELECT 'PRACTITIONER', 'lds_source_record_id', COUNT(*), COUNT(DISTINCT lds_source_record_id) FROM OLIDS_COMMON.PRACTITIONER
    ...
    UNION ALL SELECT 'PRACTITIONER_IN_ROLE', 'lds_source_record_id', COUNT(*), COUNT(DISTINCT lds_source_record_id) FROM OLIDS_COMMON.PRACTITIONER_IN_ROLE
    ...
    UNION ALL SELECT 'SCHEDULE', 'lds_source_record_id', COUNT(*), COUNT(DISTINCT lds_source_record_id) FROM OLIDS_COMMON.SCHEDULE
    ...
    UNION ALL SELECT 'SCHEDULE_PRACTITIONER', 'lds_source_record_id', COUNT(*), COUNT(DISTINCT lds_source_record_id) FROM OLIDS_COMMON.SCHEDULE_PRACTITIONER
    ...
    -- CONCEPT (OLIDS_TERMINOLOGY) — only concept_id available
    UNION ALL SELECT 'CONCEPT', 'concept_id', COUNT(*), COUNT(DISTINCT concept_id) FROM OLIDS_TERMINOLOGY.CONCEPT

    -- CONCEPT_MAP (OLIDS_TERMINOLOGY) — only mapped_item_id available
    UNION ALL SELECT 'CONCEPT_MAP', 'mapped_item_id', COUNT(*), COUNT(DISTINCT mapped_item_id) FROM OLIDS_TERMINOLOGY.CONCEPT_MAP
)
