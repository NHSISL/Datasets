create or replace TABLE "Data_Store_OLIDS_UAT".OLIDS_COMMON.PROCEDURE_REQUEST (
	...
	PROCEDURE_REQUEST_SOURCE_CONCEPT_ID VARCHAR(16777216),
	STATUS_CONCEPT_ID VARCHAR(16777216),
