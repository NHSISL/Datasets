create or replace TABLE "Data_Store_OLIDS_Dummy".OLIDS_MASKED.EPISODE_OF_CARE (
	...
	"episode_type_source_concept_id" VARCHAR(16777216),
	"episode_status_source_concept_id" VARCHAR(16777216),
	"episode_of_care_start_date" TIMESTAMP_NTZ(9),
	"episode_of_care_end_date" TIMESTAMP_NTZ(9),
	"care_manager_practitioner_id" VARCHAR(16777216)
);