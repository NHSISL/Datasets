...
| --- | --- | --- | --- | --- | --- |
| KI01 | Encounters | is latest fails to select single record for eventlink sequenced | Duplicates | ![Status](https://img.shields.io/badge/Status-Accepted-darkgreen) | ![Owner](https://img.shields.io/badge/LDS-00ADC3) |
