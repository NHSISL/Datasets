...
| KI07 | Location records absent. | A transform defect is resulting in the exclusion of a high volume of Location records | USers will see an increase in referential integrity failures against the Location ID | ![Status](https://img.shields.io/badge/Status-Open-red) <br>[![DevOps](https://img.shields.io/badge/DevOps-29804-blue)](https://dev.azure.com/NELAnalytics/LondonDataService/_workitems/edit/29804) | ![Owner](https://img.shields.io/badge/LDS-00ADC3) |
