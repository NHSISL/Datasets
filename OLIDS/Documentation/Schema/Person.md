...
| `LDS_SOURCE_DATASET` | `VARCHAR` | The source dataset name for this record | | | -- |
...
| `DATE_OF_BIRTH_PRECISION` | `VARCHAR` | The degree of precision in the known date of birth | | | -- |
...
| `DATE_OF_DEATH_PRECISION` | `VARCHAR` | The degree of precision in the known date of birth | | | -- |
...
| `AS_AT_DATE` | `VARCHAR` | The date the PDS record was valid as at. NULL for EMIS stub rows. | | ❌ column removed | -- |
| `LOCAL_PATIENT_ID` | `VARCHAR` | Local patient identifier from the PDS response. NULL for EMIS stub rows. | | ❌ column removed | -- |
| `INTERNAL_ID` | `VARCHAR` | PDS internal identifier. NULL for EMIS stub rows. | | ❌ column removed | -- |
...
| `MPS_ID` | `VARCHAR` | Master Patient Service identifier from PDS. NULL for EMIS stub rows. | | ❌ column removed | -- |
| `IS_PATIENT_FLAGGED_SENSITIVE` | `BOOLEAN` | True where patient is flagged as sensitive. | | | -- |
...
| `IS_LATEST_FOR_PERSON` | `BOOLEAN` | True where this description of the person is the latest known description of the person | | | -- |
| `IS_LATEST_FOR_ACCOUNT` | `BOOLEAN` | True where this description of the person is the latest permissible description shareable with the subscriber account (should be true in all cases) | | | -- |
