# OLIDS Known Issues (Synapse platform delivery)

- [OLIDS Known Issues (Synapse platform delivery)](#olids-known-issues-synapse-platform-delivery)
  - [⛔ Data availability issues](#-data-availability-issues)
    - [📈 historical episodes of care: EMIS patients](#-historical-episodes-of-care-emis-patients)
    - [⚙️ Optum group configuration errors](#️-optum-group-configuration-errors)
    - [❌ Allocation failures (NWL and NCL practices)](#-allocation-failures-nwl-and-ncl-practices)
    - [⛔ Known bulk failures](#-known-bulk-failures)
      ...
      - [DevOps 27617 - SystmOne extract misconfiguration, NWL Group 16](#devops-27617---systmone-extract-misconfiguration-nwl-group-16)
      - [Unknown bulk error - NWL SystmOne Groups 14 and 5](#unknown-bulk-error---nwl-systmone-groups-14-and-5)
  - [🏗️ Schema issues](#️-schema-issues)
    - [general](#general)
  ...
  - [`RECORD_OWNER_ORGANISATION_CODE` Evolution](#record_owner_organisation_code-evolution)
