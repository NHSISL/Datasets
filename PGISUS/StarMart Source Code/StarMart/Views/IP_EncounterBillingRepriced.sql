CREATE VIEW [StarMart].[IP_EncounterBillingRepriced]
AS
SELECT [Generated_Record_ID] = [EP].[Generated Record ID]
	...
	,[dv_Excess_Bed_Days_Adjustment] = [IP_Billing].[Excess Bed Days Adjustment]
...
WHERE (
	...
	AND NOT (
		[IP_Billing].[ActivityPeriod] BETWEEN [Grouper].[PeriodFrom] AND [Grouper].[PeriodTo]
